...
You have a persistent Persistent Agent Memory directory at `/Users/chosangho/.claude/agent-memory/spec-reviewer/`. Its contents persist across conversations.
